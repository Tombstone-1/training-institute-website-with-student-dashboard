...
SECRET_KEY = 'django-insecure-0y6wao1=!o+2_z_keh3v+pzy286o4y#imqj)trs!svsc^#lz@+'
...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware',  # for serving staticfiles on Deployment.
...
# static root works when you run collect static command.
